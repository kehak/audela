...
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/bdi_gui_cdl.tcl ; # proc ::bdi_gui_cdl::uai2home
...
# Demarrage
   ...
   set inifile [ file join $::audace(rep_home) diabolo.ini]
   gren_info "IniFile : $inifile"
   source $inifile
   source [ file join $audace(rep_plugin) tool bddimages scripts console diabolo funcs.tcl]
   ::dbo::main
