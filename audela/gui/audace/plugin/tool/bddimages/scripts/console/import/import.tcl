...
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/bdi_tools_astroid.tcl
...
# Demarrage
   ...
   source [ file join $audace(rep_home) import.ini]
   source [ file join $audace(rep_plugin) tool bddimages scripts console import main.tcl]
   gren_info "Action..."
   main
