...
# Demarrage
   gren_info "Chargement des routines :"
   gren_info "File : [ file join $audace(rep_plugin) tool bddimages scripts console test libcatalog main.ini]"
   source [ file join $audace(rep_plugin) tool bddimages scripts console test libcatalog main.ini]
   gren_info "File : [ file join $audace(rep_plugin) tool bddimages scripts console test libcatalog funcs.tcl]"
   source [ file join $audace(rep_plugin) tool bddimages scripts console test libcatalog funcs.tcl]
   gren_info "Demarrage:"
   main
