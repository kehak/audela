...
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/bddimages_go.tcl
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/scripts/console/planif/tools_planif.tcl 
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/scripts/console/planif/tools_planif_parse.tcl 
source $audace(rep_install)/gui/audace/plugin/tool/bddimages/scripts/console/planif/horizon_telescope.tcl 
source [ file join $::audace(rep_home) planif.ini]

::bddimages::ressource

# Demarrage
   gren_info "Demarrage: UAICODE = $::tools_planif::uai_code\n"
   set err [catch { ::tools_planif::run } msg ]
   gren_info "-------------------"
   gren_info "Planif END"
