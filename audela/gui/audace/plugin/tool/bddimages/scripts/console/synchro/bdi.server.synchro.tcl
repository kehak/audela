...
# Demarrage
   ...
   gren_info "File : [ file join $audace(rep_home) bdi.server.synchro.ini]"
   source [ file join $audace(rep_home) bdi.server.synchro.ini]
   gren_info "File : [ file join $audace(rep_plugin) tool bddimages scripts console synchro funcs.tcl]"
   source [ file join $audace(rep_plugin) tool bddimages scripts console synchro funcs.tcl]
   gren_info "Demarrage:"
   server
