...
uplevel #0 "source \"[file join $audace(rep_install) gui audace aud_proc.tcl]\""
...
# Demarrage
   ...
   source [ file join $audace(rep_plugin) tool bddimages scripts console createdb createdb.ini]
   source [ file join $audace(rep_plugin) tool bddimages scripts console createdb main.tcl]
   gren_info "Action..."
   main
