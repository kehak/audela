...
#ifdef  _WIN32  
#if _MSC_VER >= 1900
// definition de stdout et stderr pour libusb-1.lib compilée avec un ancien Visual studio
//FILE _iob[] = { *stdin, *stdout, *stderr };
FILE _iob[3];  // voir usb_init()
...
gp_port_library_list (GPPortInfoList *list)
{
   ...
   //modif michel
	...
	gp_port_info_set_name (info, "usb");
