/*
 *
 *	xclibsc.h	External	13-Feb-2014
 *
 ...
 * Open/close/faults
 */
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_PIXCIopen(const char *driverparms, const char *formatname, const char *formatfile);
...
_cDcl(_dllpxlib,_cfunfcc,int)	    pxe_PIXCIopen(pxdstate_s*, const char *driverparms, const char *formatname, const char *formatfile);
...
#if defined(OS_WIN64) | defined(OS_WIN64_DLL) | defined(C_GNU64) | defined(C_LSB64)
_cDcl(_dllpxlib,_cfunfcc,uint64)	pxd_infoMemsize(int unitmap);
#else
_cDcl(_dllpxlib,_cfunfcc,ulong) 	pxd_infoMemsize(int unitmap);
#endif
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_infoSysTicksUnits(uint32 ticku[2]);
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_infoSysTicks(uint32 ticks[2]);
...
#endif
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_infoSysTicksUnits(pxdstate_s*,uint32 ticku[2]);
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_infoSysTicks(pxdstate_s*,uint32 ticks[2]);
...
/*
 * SV2/SV3/SV4/SV5/SV7 Video adjust
 */
...
/*
 * Newer style ADC adjustments.
 */
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_setAdcGainOffset(int unitmap,int rsvd,double gainA,double offsetA,double gainB,double offsetB);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_setAdcColorGainOffsets(int unitmap,int rsvd,double gainsA[4],double gainsB[4],double offsetsA[4],double offsetsB[4]);
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_getAdcGainA(int unitmap);
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_getAdcGainB(int unitmap);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_getAdcGainsA(int unitmap,double gainsA[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_getAdcGainsB(int unitmap,double gainsB[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_getAdcOffsetsA(int unitmap,double offsetsA[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_getAdcOffsetsB(int unitmap,double offsetsB[4]);
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_getAdcOffsetA(int unitmap);
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_getAdcOffsetB(int unitmap);

_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_setAdcGainOffset(pxdstate_s*,int unitmap,int rsvd,double gainA,double offsetA,double gainB,double offsetB);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_setAdcColorGainOffsets(pxdstate_s*,int unitmap,int rsvd,double gainsA[4],double gainsB[4],double offsetsA[4],double offsetsB[4]);
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_getAdcGainA(pxdstate_s*,int unitmap);
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_getAdcGainB(pxdstate_s*,int unitmap);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_getAdcGainsA(pxdstate_s*,int unitmap,double gainsA[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_getAdcGainsB(pxdstate_s*,int unitmap,double gainsB[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_getAdcOffsetsA(pxdstate_s*,int unitmap,double offsetsA[4]);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_getAdcOffsetsB(pxdstate_s*,int unitmap,double offsetsB[4]);
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_getAdcOffsetA(pxdstate_s*,int unitmap);
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_getAdcOffsetB(pxdstate_s*,int unitmap);


/*
 * D/D24/D32/A/D2X/D3X/D3XE/CL1/CL2/E1/E4/EB1/EB1POCL/EB1MINI/EC1/ECB1/ECB134/ECB2/EL1/E1DB
 * /EL1DB/ELS2/E4DB/CL3SD/SI/SI1/SI2/SI4/E8/E8CAM/E8DB/e104x4/E4G2 Video adjust.
 *
 ...
 */
    ...
    |defined(OS_WINNT)|defined(OS_WINNT_DLL)|defined(OS_WINNT_UMDF) \
    |defined(OS_WIN64)|defined(OS_WIN64_DLL)|defined(OS_WIN64_UMDF)
 ...
 * Load/Save.
 */
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_saveBmp(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_loadBmp(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int loadmode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_saveTga(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_savePcx(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_saveTiff(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_loadTiff(int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int loadmode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_saveRawBuffers(int unitmap,const char *pathname, pxbuffer_t startbuf, pxbuffer_t endbuf, void *filehandle, pxbuffer_t fileoffset, uint32 alignment,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxd_loadRawBuffers(int unitmap,const char *pathname, pxbuffer_t startbuf, pxbuffer_t endbuf, void *filehandle, pxbuffer_t fileoffset, uint32 alignment,int options);

_cDcl(_dllpxlib,_cfunfcc,int)	pxe_saveBmp(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_loadBmp(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int loadmode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_saveTga(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_savePcx(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_saveTiff(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int savemode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_loadTiff(pxdstate_s*,int unitmap, const char *pathname,pxbuffer_t buf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,int loadmode,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_saveRawBuffers(pxdstate_s*,int unitmap,const char *pathname, pxbuffer_t startbuf, pxbuffer_t endbuf, void *filehandle, pxbuffer_t fileoffset, uint32 alignment,int options);
_cDcl(_dllpxlib,_cfunfcc,int)	pxe_loadRawBuffers(pxdstate_s*,int unitmap,const char *pathname, pxbuffer_t startbuf, pxbuffer_t endbuf, void *filehandle, pxbuffer_t fileoffset, uint32 alignment,int options);
...
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clSerialInit();
_cDcl(_dllpxlib _dllclser,__cdecl,void)       clSerialClose();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clSerialRead();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clSerialWrite();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetNumBytesAvail();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clFlushPort();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetErrorText();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetNumSerialPorts();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetSerialPortIdentifier();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetManufacturerInfo();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clGetSupportedBaudRates();
_cDcl(_dllpxlib _dllclser,__cdecl,sint32)     clSetBaudRate();
#endif
...
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_SILICONVIDEO_getCameraType(int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_SILICONVIDEO_getCtrlExposure(int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,double)  pxd_SILICONVIDEO_getMinMaxCtrlExposure(int unitmap,double exposure);
...
_cDcl(_dllpxlib,_cfunfcc,int) pxe_SILICONVIDEO_setAxC(pxdstate_s*,int unitmap,int rsvd,
				    int agcA,int agcB,int rsvd2,int rsvd3,int aec,int rsvd4,int rsvd5,int rsvd6,int rsvd7);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_SILICONVIDEO_getCameraType(pxdstate_s*,int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_SILICONVIDEO_getCtrlExposure(pxdstate_s*,int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,double)  pxe_SILICONVIDEO_getMinMaxCtrlExposure(pxdstate_s*,int unitmap,double exposure);
...
//
// Values for pxd_SILICONVIDEO_getCameraType
//
#define SILICONVIDEO_HAS21    0x8A52
#define SILICONVIDEO_2112     2112
#define SILICONVIDEO_1310     1310
#define SILICONVIDEO_1281     1281
#define SILICONVIDEO_9M001    0x901a
#define SILICONVIDEO_9T001    0x901b
#define SILICONVIDEO_5CM10    0x901c
#define SILICONVIDEO_9C10     0x901d
#define SILICONVIDEO_10CM6    0x901e
#define SILICONVIDEO_10CL     0x901f
#define SILICONVIDEO_15C5     0x902a
#define SILICONVIDEO_642      642
#define SILICONVIDEO_643      643
#define SILICONVIDEO_WGA      9032
#define SILICONVIDEO_2KS      2000
#define SILICONVIDEO_1CM45    0x1C45
...
#define pxd_videoFormatAsIncluded(rsvd) \
     ...
     (pxd_videoFormatAsIncluded_vidstate.xc.anaformat= (xcanaformat_s*)&xcsv2format_32_id31232),\
     (pxd_videoFormatAsIncluded_vidstate.xc.anamode  = (xcanamode_s*)&xcsv2mode_21_id31232),\
 ...
 *	int r;
 *	#include "newformat.fmt"
 *	pxe_videoFormatAsIncludedInit(pxdstate, 0)
 *	r = pxe_videoFormatAsIncluded(pxdstate, 0);
 *	if (r < 0)
 *	    ...
 *  }
 *
 */
#define pxd_videoFormatAsIncludedInit(Rsvd) \
     struct pxvidstate	 _videoFormatAsIncluded_vidstate;  \
     int		 _videoFormatAsIncluded_r1;	   \
     int		 _videoFormatAsIncluded_r2;	   \
     memset(&_videoFormatAsIncluded_vidstate, 0, sizeof(_videoFormatAsIncluded_vidstate)); \
     (_videoFormatAsIncluded_vidstate.ddch.len	  = sizeof(_videoFormatAsIncluded_vidstate)); \
     (_videoFormatAsIncluded_vidstate.ddch.mos	  = PXMOS_VIDSTATE); \
     (_videoFormatAsIncluded_vidstate.vidformat   = &pxvidformat_561_id31232); \
     (_videoFormatAsIncluded_vidstate.vidres	  = &pxvidres_125_id31232); \
     (_videoFormatAsIncluded_vidstate.vidmode	  = &pxvidmode_79_id31232); \
     (_videoFormatAsIncluded_vidstate.vidphys	  = &pxvidphys_118_id31232); \
     (_videoFormatAsIncluded_vidstate.vidimage	  = &pxvidimage_251_id31232); \
     (_videoFormatAsIncluded_vidstate.vidopt	  = &pxvidopt_19_id31232); \
     (_videoFormatAsIncluded_vidstate.vidmem	  = &pxvidmem_72_id31232); \
     (_videoFormatAsIncluded_vidstate.camcntl	  = &pxcamcntl_264_id31232); \
     (_videoFormatAsIncluded_vidstate.xc.anaformat= (xcanaformat_s*)&xcsv2format_32_id31232); \
     (_videoFormatAsIncluded_vidstate.xc.anamode  = (xcanamode_s*)&xcsv2mode_21_id31232); \
     (_videoFormatAsIncluded_vidstate.xc.dxxformat= &xcdxxformat_45_id31232);
#define pxd_videoFormatAsIncluded(Rsvd) \
     (pxd_goAbortLive((1<<pxd_infoUnits())-1),\
     (_videoFormatAsIncluded_r1 = pxd_xclibEscape(0,0,0)->pxlib.defineState(&pxd_xclibEscape(0,0,0)->pxlib, 0, PXMODE_DIGI+0, &_videoFormatAsIncluded_vidstate)),\
     (_videoFormatAsIncluded_r2 = pxd_xclibEscaped(0,0,0)), \
     ((_videoFormatAsIncluded_r1 < _videoFormatAsIncluded_r2) ? _videoFormatAsIncluded_r1 : _videoFormatAsIncluded_r2))


#define pxe_videoFormatAsIncludedInit(Pxdstate, Rsvd) \
     struct pxvidstate	 _videoFormatAsIncluded_vidstate;  \
     int		 _videoFormatAsIncluded_r1;	   \
     int		 _videoFormatAsIncluded_r2;	   \
     memset(&_videoFormatAsIncluded_vidstate, 0, sizeof(_videoFormatAsIncluded_vidstate)); \
     ...
     (_videoFormatAsIncluded_vidstate.xc.anamode  = (xcanamode_s*)&xcsv2mode_21_id31232); \
     (_videoFormatAsIncluded_vidstate.xc.dxxformat= &xcdxxformat_45_id31232);
#define pxe_videoFormatAsIncluded(Pxdstate, Rsvd) \
     (pxe_goAbortLive(Pxdstate, (1<<pxe_infoUnits(Pxdstate))-1),\
     (_videoFormatAsIncluded_r1 = pxe_xclibEscape(Pxdstate, 0,0,0)->pxlib.defineState(&pxe_xclibEscape(Pxdstate,0,0,0)->pxlib, 0, PXMODE_DIGI+0, &_videoFormatAsIncluded_vidstate)),\
     (_videoFormatAsIncluded_r2 = pxe_xclibEscaped(Pxdstate,0,0,0)), \
     ((_videoFormatAsIncluded_r1 < _videoFormatAsIncluded_r2) ? _videoFormatAsIncluded_r1 : _videoFormatAsIncluded_r2))
 ...
 * Assumes one frame grabber is in use. Not a complete set of
