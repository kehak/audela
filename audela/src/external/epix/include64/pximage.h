/*
 *
 *	pximage.h	External	08-Jun-2011
 *
 *	Copyright (C)  1984-2011  EPIX, Inc.  All rights reserved.
 *
...
#if defined(C_MSC64)|defined(C_GNU64)|defined(C_LSB64)
...
#elif defined(C_MSC32)|defined(C_BOR32)|defined(C_WAT32)|defined(C_TMSC40)|defined(C_GNU32)|defined(C_LSB32)
#define PXDATUINT8	0x01
#define PXDATUINT16	0x02
...
#define PXDATFLT4	0x10
#define PXDATFLT8	0x20
#elif defined(C_GNU64)|defined(C_LSB64)
#define PXDATUINT8	0x01
#define PXDATUINT16	0x02
#define PXDATUINT32	0x04
#define PXDATFLT4	0x10
...
struct	pximage
{
    ...
    struct {
	#if defined(C_GNU64)|defined(C_LSB64)
     ...
     * accessing some frame grabbers with video on versus off, etc.).
     * Very approximate!!!
     *
