/*
 *
 *	cext.h		External	11-Jul-2014
 *
 *	Copyright (C)  1988-2014  EPIX, Inc.  All rights reserved.
 *
 ...
 */
#if defined(__GNUC__)&&!defined(__LSB_VERSION__)
...
/*
 * LSB C 64 bit
 * Test before defined(__GNUC__) as LSB uses GNUC!
 */
#elif (defined(__LSB_VERSION__) && defined(_x86_64))
    ...
    #define _cDcl(X,L,T)  X T L /* decl syntax				    */
    #if !defined(C_LSB64)
	#define C_LSB64 0000	/* simplify other .h logic		    */
    #endif
    typedef signed char 	sint8;
    typedef signed short	sint16;
    typedef signed int		sint32;
 ...
 */
    ...
    #define _cDcl(X,L,T)  X T L /* decl syntax				    */
    #if !defined(C_LSB32)
	#define C_LSB32 0000	/* simplify other .h logic		    */
    #endif
    typedef signed char 	sint8;
    typedef signed short	sint16;
    typedef signed int		sint32;
 ...
 */
	...
	#if !defined(OS_WINNT)&!defined(OS_WINNT_DLL)&!defined(OS_WINNT_KMD)&!defined(OS_WINNT_WDM)&!defined(OS_WIN64_WDM)&!defined(OS_WINNT_UMDF)&!defined(OS_WIN64_UMDF)
 ...
 */
	...
	#undef	_farphy
	#define _farphy 			/* all compilers: disable _far */
	#if !defined(OS_WIN64)&!defined(OS_WIN64_DLL)&!defined(OS_WIN64_WDM)&!defined(OS_WIN64_UMDF)
