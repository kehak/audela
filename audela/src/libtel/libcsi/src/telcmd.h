...
static struct cmditem cmdlist[] = {
   ...
   {"dome",(Tcl_CmdProc *)cmdTelDome},\
   {"rotate",(Tcl_CmdProc *)cmdTelRotate},\
   {"pos0",(Tcl_CmdProc *)cmdTelPos0},\
   {"security",(Tcl_CmdProc *)cmdTelSecurity},\
   {"encoders",(Tcl_CmdProc *)cmdTelEncoders},\
   {"trackingduration",(Tcl_CmdProc *)cmdTelTrackingDuration},\
   {NULL, NULL}
};
