...
int gemini_setlatitude(struct telprop *tel,double latitude);
int gemini_getlatitude(struct telprop *tel,double *latitude);
int gemini_gettsl(struct telprop *tel,double *tsl);
...
int gemini_angle_ra2hms(char *in, char *out);
int gemini_angle_dec2dms(char *in, char *out);
int gemini_angle_hms2ra(struct telprop *tel, char *in, char *out);
int gemini_angle_dms2dec(struct telprop *tel, char *in, char *out);

int gemini_setderive(struct telprop *tel,int var,int vdec);
int gemini_getderive(struct telprop *tel,int *var,int *vdec);

int gemini_settsl(struct telprop *tel);
