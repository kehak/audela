...
int cmdSerialChar (ClientData clientData, Tcl_Interp *interp, int argc, const char *argv[]);
int cmdSerialBit  (ClientData clientData, Tcl_Interp *interp, int argc, const char *argv[]);
