 ...
 */
void PsfFitter::fitProfile(CBuffer* const theBufferImage, double xCenter, double yCenter, const int minimumRadius, const int maximumRadius,
 ...
 * Extract pixels needed for the fit
 */
void PsfFitter::extractProcessingZoneMaximumRadius(CBuffer* const theBufferImage, double& xCenter, double& yCenter, const int theRadius,
