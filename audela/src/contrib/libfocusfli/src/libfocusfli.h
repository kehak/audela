...
#ifndef __LIBFOCUSFLIH__
#define __LIBFOCUSFLIH__
...
#if defined(LIBRARY_DLL)
   __declspec(dllexport) int __cdecl Focusfli_Init(Tcl_Interp *interp);
#endif
#if defined(LIBRARY_SO)
   extern int focusfli_Init(Tcl_Interp *interp);
#endif
