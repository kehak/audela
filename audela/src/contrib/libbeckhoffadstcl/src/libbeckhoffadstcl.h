...
#ifndef __LIBBECKHOFFADSTCLH__
#define __LIBBECKHOFFADSTCLH__
...
#if defined(LIBRARY_DLL)
   __declspec(dllexport) int __cdecl Beckhoffadstcl_Init(Tcl_Interp *interp);
#endif
#if defined(LIBRARY_SO)
   extern int Beckhoffadstcl_Init(Tcl_Interp *interp);
#endif
