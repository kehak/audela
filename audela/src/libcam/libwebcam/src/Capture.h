...
class CCapture {
  ...
  public:
    ...
    virtual BOOL openDlgVideoFormat(char* errorMessage)=0;
    virtual BOOL openDlgVideoSource(char* errorMessage)=0;
    virtual BOOL openDlgVideoDisplay(char* errorMessage)=0;
    virtual BOOL openDlgVideoCompression(char* errorMessage)=0;
