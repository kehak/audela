...
*----------------------------------------------------------------------
*/
BOOL CCaptureWinVfw::openDlgVideoFormat(char* errorMessage) {
   BOOL result ;
...
BOOL CCaptureWinVfw::openDlgVideoSource(char* errorMessage) {
   BOOL result ;
...
BOOL CCaptureWinVfw::openDlgVideoDisplay(char* errorMessage) {
   BOOL result ;
...
BOOL CCaptureWinVfw::openDlgVideoCompression(char* errorMessage) {
   BOOL result ;
