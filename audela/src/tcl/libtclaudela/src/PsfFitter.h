...
#include <abaudela.h> // pour IBuffer
...
protected:
   ...
   void extractProcessingZoneMaximumRadius(abaudela::IBuffer* const theBufferImage, int xCenter, int yCenter, const int theRadius,
...
public:
	...
	virtual ~PsfFitter();
	void fitProfile(abaudela::IBuffer* const theBufferImage, double xCenter, double yCenter, const int minimumRadius, const int maximumRadius,
